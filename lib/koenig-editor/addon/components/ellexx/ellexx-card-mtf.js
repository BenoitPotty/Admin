...
export default EllexxComponent.extend({
    init() {
        ...
        this.initField('mtf_type');
        this.initField('mtf_type_display');
        this.initField('mtf_payment_method');
        this.initField('mtf_payment_method_display');
        ...
        this.initField('mtf_job');
        this.initField('mtf_income');
        this.initField('mtf_debts');
        this.initField('mtf_largest_expense_item');
        this.initField('mtf_capital');
    ...
    setDefaultValueIfNeeded() {
        ...
        ellexxCardUtils.updatePayloadAttribute(this.payload, 'mtf_lang', 'de', this.saveCard);
    }
});
