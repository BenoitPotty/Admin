...
const cardsToAdd = [
    ...
    },
    {
        ...
        menuItems: [
            {
                label: 'Vertical collection',
                desc: 'Insert a \'Vertical Collection\' box',
                iconClass: 'kg-card-type-native',
                matches: ['verticalcollectio', 'vcol'],
                type: 'card',
                replaceArg: 'vcol'
            }
        ]
    },
    {
        ...
        menuItems: [
            ...
            {
                label: '(Product) Video',
                desc: 'Insert an \'Video\' for a Product',
                iconClass: 'kg-card-type-native',
                matches: ['teaser', 'tbi'],
                type: 'card',
                replaceArg: 'tbi',
    ...
    //     menuItems: [
    //         {
    //             label: '(Articles) Mini Excerpt',
    //             desc: 'Insert a \'Mini Excerpt\' for Articles',
    //             iconClass: 'kg-card-type-native',
    //             matches: ['mini'],
    //             type: 'card',
    //             replaceArg: 'mini'
