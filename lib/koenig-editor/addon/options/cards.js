...
export default [
    ...
    createComponentCard('tsb', {selectAfterInsert: true}),
...
export const CARD_MENU = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: 'Teaser Block',
                icon: 'ellexx/card-indicator-tsb',
                desc: 'Teaser Block Eingeben',
                iconClass: 'kg-card-type-native',
                matches: ['teaser', 'tsb'],
                type: 'card',
                replaceArg: 'tsb'
