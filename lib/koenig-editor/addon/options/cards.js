...
export const CARD_ICON_MAP = {
    ...
    mdh: 'koenig/kg-card-type-markdown',
    ...
    zdt: 'ellexx/card-indicator-zdt',
    fdw: 'ellexx/card-indicator-fdw',
    zit: 'ellexx/card-indicator-zit',
    vid: 'koenig/kg-card-type-gen-embed',
    ifk: 'koenig/kg-card-type-gen-embed',
    lnk: 'ellexx/card-indicator-lnk',
    mtf: 'ellexx/card-indicator-mtf',
    tbi: 'ellexx/card-indicator-tbi',
    pdf: 'ellexx/card-indicator-pdf'
};
...
export default [
    ...
    createComponentCard('zdt', {selectAfterInsert: true}),
    createComponentCard('fdw', {selectAfterInsert: true}),
    createComponentCard('zit', {selectAfterInsert: true}),
    createComponentCard('lnk', {selectAfterInsert: true}),
    createComponentCard('mtf', {selectAfterInsert: true}),
    createComponentCard('tbi', {selectAfterInsert: true, type: 'Infographik'}),
    createComponentCard('vid', {hasEditMode: false, deleteIfEmpty: 'payload.html'}),
    createComponentCard('ifk', {hasEditMode: false, deleteIfEmpty(card) {
        return card.payload.imageSelector && !card.payload.src;
    }}),
    createComponentCard('mdh', {deleteIfEmpty: 'payload.markdown'}),
    createComponentCard('pdf', {hasEditMode: false, deleteIfEmpty(card) {
        return card.payload.imageSelector && !card.payload.src;
    }})
];
